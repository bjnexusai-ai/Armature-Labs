    ...
    >
      <div className="modal-box w-full max-w-[480px] bg-card-bg rounded-[20px] p-[26px_26px_22px] shadow-[0_30px_70px_rgba(10,30,30,0.28)] max-h-[86vh] overflow-y-auto">
        <div className="flex justify-between items-start mb-4">
          <div>
            <h3 className="font-display text-[17px] font-bold text-ink m-0">New manufacturer</h3>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-5">
            <label className="block text-[12.5px] font-semibold text-ink mb-1.5">Country (2-letter code)</label>
            <input
